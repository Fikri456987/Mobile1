...
class MainActivity : AppCompatActivity() {
    ...
    private fun isiGambar(txtHello: TextView, image1: ImageView){
        ...
        when (tes) {
            1 -> image1.setImageDrawable(getDrawable(R.drawable.messi1))
            2 -> image1.setImageDrawable(getDrawable(R.drawable.messi2))
            3 -> image1.setImageDrawable(getDrawable(R.drawable.messi3))
            4 -> image1.setImageDrawable(getDrawable(R.drawable.messi5))
            5 -> image1.setImageDrawable(getDrawable(R.drawable.messi4))
            else -> { // Note the block
                image1.setImageDrawable(getDrawable(R.drawable.messi6))
            }
        }
    }
